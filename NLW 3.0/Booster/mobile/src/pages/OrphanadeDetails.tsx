const ipServer = "192.168.2.109"; // como o banco está salvando as imagem com url localhos uso esse ipServer para fazer um replace na string
...
import mapMarkerImg from "../img/mapMarker.png";
      ...
      <View style={styles.imagesContainer}>
        <ScrollView horizontal pagingEnabled>
          {orphanage.images.map((image) => {
            const valUrl = image.url.replace("localhost", ipServer);
            return (
              <Image
                key={image.id}
                style={styles.image}
